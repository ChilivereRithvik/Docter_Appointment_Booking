...
// import { initialValues } from antd;
...
//                     <form onSubmit={handleSubmit} initialValues={docter}>
...
//                         <input id="feesPreCunsaltation" placeholder='Your Fees Pre Cunsaltation' type='number' name="feesPreCunsaltation" className='inp' value={formData.feesPreCunsaltation} onChange={handleChange} required>
